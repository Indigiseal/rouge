...
const EVENT_TEXT_ADDITIONS = {
    en: {
        ...
        'event.reward.eggNoRoom': 'No room for the egg — you eat it where you stand (+{amount} HP)',
    ...
    es: {
        ...
        'event.reward.eggNoRoom': 'No hay sitio para el huevo: te lo comes allí mismo (+{amount} PV)',
    ...
    fr: {
        ...
        'event.reward.eggNoRoom': 'Pas de place pour l’oeuf — vous le mangez sur place (+{amount} PV)',
    ...
    ru: {
        ...
        'event.reward.eggNoRoom': 'Места под яйцо нет — съедаешь его на месте (+{amount} ОЗ)',
...
const GERMAN_STRINGS = {
    ...
    'event.reward.eggNoRoom': 'Kein Platz für das Ei — du isst es an Ort und Stelle (+{amount} LP)',
...
const DESCRIPTION_TRANSLATIONS = {
    fr: {
        ...
        'dual wield': 'double arme', 'cleave: half damage to adjacent enemies while AP remains': 'fauchage : demi-dégâts aux ennemis adjacents tant qu’il reste des PA', 'piercing: half damage to enemies behind target while AP remains': 'perforation : demi-dégâts aux ennemis derrière la cible tant qu’il reste des PA', 'hits any enemy': 'touche n’importe quel ennemi', 'can block': 'peut bloquer', 'heavy cleave; executes wounded non-boss enemies': 'fauchage lourd ; exécute les ennemis blessés hors boss', 'magic cards cannot merge': 'les cartes magiques ne peuvent pas fusionner', 'gems socket into weapons': 'les gemmes se sertissent dans les armes', 'different family': 'famille différente', 'stats/effect differ': 'statistiques/effet différents',
    },
    es: {
        ...
        'cleave: half damage to adjacent enemies while AP remains': 'barrido: medio daño a enemigos adyacentes mientras queden PA',
        'piercing: half damage to enemies behind target while AP remains': 'perforación: medio daño a enemigos detrás del objetivo mientras queden PA',
        'hits any enemy': 'golpea a cualquier enemigo',
        'can block': 'puede bloquear',
        'heavy cleave; executes wounded non-boss enemies': 'barrido pesado; ejecuta enemigos heridos que no sean jefes',
    ...
    ru: {
        ...
        'cleave: half damage to adjacent enemies while AP remains': 'размашистый удар: половина урона соседним врагам, пока есть ОД',
        'piercing: half damage to enemies behind target while AP remains': 'пронзание: половина урона врагам позади цели, пока есть ОД',
        'hits any enemy': 'бьет любого врага',
        'can block': 'может блокировать',
        'heavy cleave; executes wounded non-boss enemies': 'тяжёлый размах; добивает раненых врагов, кроме боссов',
