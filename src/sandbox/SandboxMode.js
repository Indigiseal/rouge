...
export const SANDBOX_ENCOUNTERS = [
  ...
  { id: 'TOLLROAD_AFTERMATH', label: 'Tollroad Aftermath', labelKey: 'ui.sandbox.encounter.tollroadAftermath', kind: 'station', sceneKey: 'TollroadAftermathScene' },
