...
Tracked in the **rouge** repo at `docs/narrative/` (this folder).

- Repo root: `/Users/petrgorskin/Projects/dungeon_rogue/rouge`
- In-repo pointer: `docs/LORE.md`
- Obsidian: `~/Documents/Obsidian Vault/Narrative` → symlink to this folder
- In-game event copy (separate): `docs/event-stories.md`
