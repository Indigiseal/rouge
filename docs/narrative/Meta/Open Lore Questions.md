...
A living list of what is not yet locked in the lore.
...
- [x] Nine locations, not twelve months. Act 2 is ossuary / **dark carnival** / **vampire castle**.
- [x] True chain: Tollroad (goblin names a god) → Brassfair (fair sells the god) → Starfold (the Magus).
...
- [x] Encounters do not need one shared plot; location weights are enough. See [[Encounter Philosophy]].
- [x] Story-forks shelved; location pick is the replay lever. See [[Design Decisions]].
- [x] Music-box lane is an any-location [[Event Sequences|Event Sequence]]; it is not location-gated.
