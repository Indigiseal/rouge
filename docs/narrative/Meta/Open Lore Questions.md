...
- [ ] Finalize the 12 names (current set is an example).
- [ ] Bind each month to biome, enemy pool, and boss.
- [ ] Decide which months lean on existing content and which need new assets.
